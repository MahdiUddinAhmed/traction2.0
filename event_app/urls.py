...
urlpatterns = [
    ...
    path('registration-complete/', views.registration_complete, name='reg-complete'),  # Add this line
    path('web-dev-team/', views.web_dev_team, name='web-dev-team'),  # Add this line
]
